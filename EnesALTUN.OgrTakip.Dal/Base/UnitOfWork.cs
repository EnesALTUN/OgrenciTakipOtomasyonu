using EnesALTUN.OgrTakip.Common.Message;
    ...
    public class UnitOfWork<T> : IUnitOfWork<T> where T : class
    {
        ...
        public bool Save()
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                switch (sqlEx.Number)   // Hata numaraları
                {
                    case 208:
                        Messages.HataMesaji("İşlem Yapmak İstediğiniz Tablo Veritabanında Bulunamadı.");
                        break;
                    case 547:
                        Messages.HataMesaji("Seçilen Kartın İşlem Görmüş Hareketleri Var Kart Silinemez."); // Kullanılan Entity Silinemez
                        break;
                    case 2601:
                    case 2627:
