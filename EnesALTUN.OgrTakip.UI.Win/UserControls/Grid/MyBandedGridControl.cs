...
namespace EnesALTUN.OgrTakip.UI.Win.UserControls.Grid
{
    ...
    public class MyBandedGridControl : GridControl
    {
        protected override BaseView CreateDefaultView()
        {
            ...
            view.Columns.AddRange(columns); // Oluşturulan column dizisini ekle
            return view;
        }
    ...
    public class MyBandedGridView : BandedGridView, IStatusBarKisaYol
    {
        ...
        protected override void OnColumnChangedCore(GridColumn column)
        {
            ...
            if (column.ColumnEdit.GetType() == typeof(RepositoryItemDateEdit))
            {
                ...
                ((RepositoryItemDateEdit)column.ColumnEdit).Mask.MaskType = MaskType.DateTimeAdvancingCaret;    // casting
            }
        }
        protected override GridColumnCollection CreateColumnCollection() => new MyGridColumnCollection(this);
        private class MyGridColumnCollection : BandedGridColumnCollection
        {
            public MyGridColumnCollection(ColumnView view) : base(view) {   }
            protected override GridColumn CreateColumn()    // Eklediğimiz Column ların AllowEdit i false olarak gelsin
            {
